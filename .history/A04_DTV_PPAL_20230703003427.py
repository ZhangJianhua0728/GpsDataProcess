...
if calc_rot_loc(x,Y,opt_theta,cxs[o],cys[o],rxs[o],rys[o])<=1:PPAL =0
elif (calc_rot_loc(x,y,opt_theta,cxs[0], cys[0],rxs[0],rys[0])>1) and (calc_rot_loc(x,y,opt_theta,cxs[1],cys[1],rxs[1],rys[1])<-1)
PPAL =1
elif (calc_rot_loc(x,y,opt_theta, cxs[1],cys[1],rxs[1],rys[1])>1) and (calc_rot_loc(x,y,opt_theta, cxs[2],cys[2],rxs[2],rys[2])-1):PPAL =2
else:
PPAL =3
return PPAL