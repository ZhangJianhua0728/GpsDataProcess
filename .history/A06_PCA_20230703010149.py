...
def show_correlation_plot(loading_df: pd.DataFrame, x_cols:list, text_labels: list, xy_labels:list):
    ...
    ax.quiver([0]*len(loading_df), [0]*len(loading_df), loading_df[x_cols[0]]*1.6, loading_df[x_cols[1]]*1.6, linewidth=0.8, 
    ...
    for i in range(len(loading_df)):
        ...
        ax.text(loading_df[x_cols[0]][i]*1.6, loading_df[x_cols[1]][i]*1.6,text_labels[i], fontsize=8, 
