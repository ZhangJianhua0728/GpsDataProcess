...
def main(file):
    ...
    data.to_csv('./{}_预处理.csv'.format(data['phone'].iloc[0]), index=False)

if __name__ == '__main__':
    csvfile ='/Users/zhangjianhua/Desktop/明觉:公路院项目/A_Code_MingJueProject/data_demo_new/14462543665.csv'
    main(csvfile)